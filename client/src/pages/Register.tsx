...
const Register = () => {
  ...
  return (
    <div className="relative min-h-screen py-10 flex items-center justify-center bg-[#050505] px-4 overflow-hidden">
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl rounded-2xl border border-white/10 p-10 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="relative w-full group py-4 bg-emerald-500 rounded-xl overflow-hidden shadow-[0_0_20px_rgba(16,185,129,0.2)] disabled:opacity-50 mt-4"
            >
